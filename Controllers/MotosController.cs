...
namespace MotoScan.Controllers
{
    ...
    [ApiController] // Apenas um atributo ApiController
    public class MotosApiController : ControllerBase
    {
        private readonly AppDbContext _dbContext;
        private readonly ImagemService _imagemService;

        public MotosApiController(AppDbContext dbContext, ImagemService imagemService)
        {
        ...
        // GET: api/Motos/5
        [HttpGet("{id:int}")]
        public async Task<ActionResult<Moto>> GetMotos(int id)
        {
        ...
        // POST: api/Motos
        [HttpPost]
        public async Task<ActionResult<Moto>> PostMotos(Moto moto)
        {
        ...
        // PUT: api/Motos/5
        [HttpPut("{id:int}")]
        public async Task<IActionResult> PutMotos(int id, Moto moto)
        {
            if (id != moto.Id)
            {
                return BadRequest();
